import { hierarchyType } from "../consts/hierarchyType";
import { checkParams, DataPrivilegeData, PrivilegeItem } from "../consts/types";
...
function dataPrivilegeDecorator(hierarchy: hierarchyType, key: string, params?: checkParams): any {
      ...
      switch (type) {
        ...
        default:
          ...
          throw new customException(
            "[DataPrivilege] the checkType only support: oceanbase, classic and customer",
            "-1"
          );
      }
...
export default dataPrivilegeDecorator;
